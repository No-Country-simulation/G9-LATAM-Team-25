Equipo tejONEs — Team 25
Hackathon ONE · Alura + Oracle 

Nombre del proyecto: HoneyGuard
...
●	Clasificación automática de contenido: Cuando un usuario carga un documento o introduce texto manualmente, el sistema analiza su contenido y determina automáticamente la categoría a la que pertenece. El documento es convertido a texto plano - El texto es limpiado y preprocesado - Se genera una representación vectorial mediante TF-IDF - El modelo de Machine Learning predice la categoría más probable - La API devuelve la categoría junto con su nivel de confianza.
